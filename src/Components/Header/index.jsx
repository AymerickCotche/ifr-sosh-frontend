...
function Header({userData, setConnected, setUser, setUserData, connected, loading}) {
  
  const dataMobiles = userData;
    ...
    <div className="">
      <div className="header-one">
        ...
        <div className="container header-one d-flex flex-wrap justify-content-center">
          <a className="navbar-brand me-md-auto animate__animated animate__bounceIn" href="/#">
              ...
              <li className="nav-item">
                ...
                <div className="dropdown">
                  <button className="btn btn-link dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    {userData ? `${dataMobiles.infos.nom} - ${dataMobiles.infos.email}` : "Veuillez vous connecter"}
                  </button>
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href="/#">Mon espace client</a></li>
                    <li><a className="dropdown-item" href="/#">Mes factures</a></li>
                    <li><hr className="dropdown-divider" /></li>
                    <li><a className="dropdown-item" href="/#" onClick={handleDisconnect}>Se déconnecter</a></li>
                  </ul>
                </div>
              </li>
            </ul>
      ...
      { connected && !loading &&
        <div className="border-bottom animate__animated animate__jackInTheBox">
